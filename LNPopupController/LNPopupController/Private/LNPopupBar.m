...
- (void)layoutSubviews
{
    ...
    [_contentView bringSubviewToFront:_separatorView];
    ...
    _shadowView.frame = CGRectMake(0, self.isInlineWithTabBar ? 0.5 : 0, _contentView.bounds.size.width, 1 / self.window.screen.scale);
    if (self.isInlineWithTabBar){
        _separatorView.frame = CGRectMake(0.5, 0, 1 / self.window.screen.nativeScale, _contentView.bounds.size.height);
    } else {
